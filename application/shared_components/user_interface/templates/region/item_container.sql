...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(353406990523672079)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24741721078608530)
,p_plug_template_id=>wwv_flow_imp.id(353406990523672079)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24742200590608531)
,p_plug_template_id=>wwv_flow_imp.id(353406990523672079)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24742748743608531)
,p_plug_template_id=>wwv_flow_imp.id(353406990523672079)
,p_name=>'Button Start'
