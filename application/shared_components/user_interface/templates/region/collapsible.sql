...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1323662703837702158)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24641725639608429)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24642217328608429)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24642780651608430)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24643208927608430)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24643759228608431)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24644228285608431)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24644783442608431)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24645240515608432)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24645738833608432)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24646249245608433)
,p_plug_template_id=>wwv_flow_imp.id(1323662703837702158)
,p_name=>'Sub Regions'
