...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1323664790628702159)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24677420694608462)
,p_plug_template_id=>wwv_flow_imp.id(1323664790628702159)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24677920324608463)
,p_plug_template_id=>wwv_flow_imp.id(1323664790628702159)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24678478842608463)
,p_plug_template_id=>wwv_flow_imp.id(1323664790628702159)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24678993180608464)
,p_plug_template_id=>wwv_flow_imp.id(1323664790628702159)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24679452761608464)
,p_plug_template_id=>wwv_flow_imp.id(1323664790628702159)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
