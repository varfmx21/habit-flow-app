...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(353402696528672076)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24754398239608544)
,p_plug_template_id=>wwv_flow_imp.id(353402696528672076)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24754809926608544)
,p_plug_template_id=>wwv_flow_imp.id(353402696528672076)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24755397891608545)
,p_plug_template_id=>wwv_flow_imp.id(353402696528672076)
,p_name=>'Sub Regions'
