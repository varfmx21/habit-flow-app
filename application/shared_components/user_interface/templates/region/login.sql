...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1323666285659702160)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24748595825608538)
,p_plug_template_id=>wwv_flow_imp.id(1323666285659702160)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24749057159608538)
,p_plug_template_id=>wwv_flow_imp.id(1323666285659702160)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24749517311608539)
,p_plug_template_id=>wwv_flow_imp.id(1323666285659702160)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24750079340608539)
,p_plug_template_id=>wwv_flow_imp.id(1323666285659702160)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24750550437608540)
,p_plug_template_id=>wwv_flow_imp.id(1323666285659702160)
,p_name=>'Sub Regions'
