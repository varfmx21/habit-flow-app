...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(691447129098361706)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24609572597608399)
,p_plug_template_id=>wwv_flow_imp.id(691447129098361706)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24610070575608400)
,p_plug_template_id=>wwv_flow_imp.id(691447129098361706)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24610575527608400)
,p_plug_template_id=>wwv_flow_imp.id(691447129098361706)
,p_name=>'Sub Regions'
