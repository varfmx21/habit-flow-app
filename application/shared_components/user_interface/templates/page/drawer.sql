...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(272845022134676897)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24494695343608296)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24495121963608296)
,p_page_template_id=>wwv_flow_imp.id(272845022134676897)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24495607653608297)
,p_page_template_id=>wwv_flow_imp.id(272845022134676897)
