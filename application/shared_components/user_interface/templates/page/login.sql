...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1323651992738702145)
,p_theme_id=>42
,p_name=>'Login'
...
,p_updated_on=>wwv_flow_imp.dz('20240914221855Z')
,p_updated_by=>'A01540618@TEC.MX'
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24523843828608321)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24524300555608322)
,p_page_template_id=>wwv_flow_imp.id(1323651992738702145)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24524844853608322)
,p_page_template_id=>wwv_flow_imp.id(1323651992738702145)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24525317432608323)
,p_page_template_id=>wwv_flow_imp.id(1323651992738702145)
,p_name=>'Body Footer'
