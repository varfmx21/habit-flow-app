...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1323654091915702146)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24550764302608345)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24551279002608346)
,p_page_template_id=>wwv_flow_imp.id(1323654091915702146)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24551788291608346)
,p_page_template_id=>wwv_flow_imp.id(1323654091915702146)
