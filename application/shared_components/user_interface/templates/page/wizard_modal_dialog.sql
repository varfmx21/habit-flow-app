...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1323656238408702149)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24574454929608366)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24574972317608366)
,p_page_template_id=>wwv_flow_imp.id(1323656238408702149)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(24575426978608367)
,p_page_template_id=>wwv_flow_imp.id(1323656238408702149)
