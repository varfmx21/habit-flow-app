...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(353533512354672190)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24936578863608721)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24937096226608721)
,p_plugin_attribute_id=>wwv_flow_imp.id(24936578863608721)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24937671227608722)
,p_plugin_attribute_id=>wwv_flow_imp.id(24936578863608721)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24938259539608723)
,p_plugin_attribute_id=>wwv_flow_imp.id(24936578863608721)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24938890767608723)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(24936578863608721)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24939313984608724)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24939895744608724)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24940360707608724)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24940875224608725)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24941358175608725)
,p_plugin_attribute_id=>wwv_flow_imp.id(24940875224608725)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24941946557608726)
,p_plugin_attribute_id=>wwv_flow_imp.id(24940875224608725)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24942583373608726)
,p_plugin_attribute_id=>wwv_flow_imp.id(24940875224608725)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24943152859608727)
,p_plugin_attribute_id=>wwv_flow_imp.id(24940875224608725)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24943747562608728)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24944269772608728)
,p_plugin_attribute_id=>wwv_flow_imp.id(24943747562608728)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24944856175608729)
,p_plugin_attribute_id=>wwv_flow_imp.id(24943747562608728)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24945479769608729)
,p_plugin_attribute_id=>wwv_flow_imp.id(24943747562608728)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24946094156608730)
,p_plugin_attribute_id=>wwv_flow_imp.id(24943747562608728)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24946670875608730)
,p_plugin_attribute_id=>wwv_flow_imp.id(24943747562608728)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24947240171608731)
,p_plugin_attribute_id=>wwv_flow_imp.id(24943747562608728)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24947859436608731)
,p_plugin_attribute_id=>wwv_flow_imp.id(24943747562608728)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24948440197608732)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2155371052983789230)
,p_plugin_id=>wwv_flow_imp.id(353533512354672190)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
