...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(353557110090672207)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1824845660406640464)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24960872452608749)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24961305452608750)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24961812718608750)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24962314297608751)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24962861372608751)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(24970005631608758)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1824845660406640464)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24963350531608752)
,p_plugin_attribute_id=>wwv_flow_imp.id(24962861372608751)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24963935100608752)
,p_plugin_attribute_id=>wwv_flow_imp.id(24962861372608751)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24964500340608753)
,p_plugin_attribute_id=>wwv_flow_imp.id(24962861372608751)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24965143695608753)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(24962861372608751)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24965659414608754)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24966141666608754)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24966613105608755)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24967117372608755)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24967644846608756)
,p_plugin_attribute_id=>wwv_flow_imp.id(24967117372608755)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24968268657608756)
,p_plugin_attribute_id=>wwv_flow_imp.id(24967117372608755)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24968809028608757)
,p_plugin_attribute_id=>wwv_flow_imp.id(24967117372608755)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24969424373608758)
,p_plugin_attribute_id=>wwv_flow_imp.id(24967117372608755)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24970005631608758)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24970530783608759)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24971045713608759)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24971530586608760)
,p_plugin_attribute_id=>wwv_flow_imp.id(24971045713608759)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24972122413608760)
,p_plugin_attribute_id=>wwv_flow_imp.id(24971045713608759)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24972718803608761)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2155366066608808719)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2155365475103801262)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2155421098773783141)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2155573316486653912)
,p_plugin_id=>wwv_flow_imp.id(353557110090672207)
