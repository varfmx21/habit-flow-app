...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(353604438808672241)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1952246662511680504)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1952246107499680503)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1695354043769406990)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25010331385608812)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25010861598608813)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25011325359608813)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25011817393608814)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25012310321608814)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25012838246608815)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25013300583608815)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25012310321608814)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1952246662511680504)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25013877884608816)
,p_plugin_attribute_id=>wwv_flow_imp.id(25013300583608815)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25014409778608816)
,p_plugin_attribute_id=>wwv_flow_imp.id(25013300583608815)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25015023086608817)
,p_plugin_attribute_id=>wwv_flow_imp.id(25013300583608815)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25015655860608817)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25013300583608815)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25016145132608818)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25016614806608819)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25017158936608819)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25017625827608820)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25018108442608820)
,p_plugin_attribute_id=>wwv_flow_imp.id(25017625827608820)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25018762125608821)
,p_plugin_attribute_id=>wwv_flow_imp.id(25017625827608820)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25019371527608821)
,p_plugin_attribute_id=>wwv_flow_imp.id(25017625827608820)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25019904862608822)
,p_plugin_attribute_id=>wwv_flow_imp.id(25017625827608820)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25020535879608822)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(25012838246608815)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1952246107499680503)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25021010251608823)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25021564892608823)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25022023969608824)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25022544000608824)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25023047702608825)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25023553223608826)
,p_plugin_attribute_id=>wwv_flow_imp.id(25023047702608825)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25024120161608826)
,p_plugin_attribute_id=>wwv_flow_imp.id(25023047702608825)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25024743022608827)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25025209463608827)
,p_plugin_attribute_id=>wwv_flow_imp.id(25024743022608827)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25025800475608828)
,p_plugin_attribute_id=>wwv_flow_imp.id(25024743022608827)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25026482821608828)
,p_plugin_attribute_id=>wwv_flow_imp.id(25024743022608827)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25027069981608829)
,p_plugin_attribute_id=>wwv_flow_imp.id(25024743022608827)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25027696090608829)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25028161534608830)
,p_plugin_attribute_id=>wwv_flow_imp.id(25027696090608829)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25028794371608830)
,p_plugin_attribute_id=>wwv_flow_imp.id(25027696090608829)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25029333720608831)
,p_plugin_attribute_id=>wwv_flow_imp.id(25027696090608829)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25029909434608831)
,p_plugin_attribute_id=>wwv_flow_imp.id(25027696090608829)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25030515728608832)
,p_plugin_attribute_id=>wwv_flow_imp.id(25027696090608829)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25031193427608832)
,p_plugin_attribute_id=>wwv_flow_imp.id(25027696090608829)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25031715863608833)
,p_plugin_attribute_id=>wwv_flow_imp.id(25027696090608829)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25032368256608833)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25032895245608834)
,p_plugin_attribute_id=>wwv_flow_imp.id(25032368256608833)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25033419537608834)
,p_plugin_attribute_id=>wwv_flow_imp.id(25032368256608833)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25034080416608835)
,p_plugin_attribute_id=>wwv_flow_imp.id(25032368256608833)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25034614093608835)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25035486832608836)
,p_plugin_attribute_id=>wwv_flow_imp.id(25034614093608835)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25036024213608837)
,p_plugin_attribute_id=>wwv_flow_imp.id(25034614093608835)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25036634284608838)
,p_plugin_attribute_id=>wwv_flow_imp.id(25034614093608835)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25037231490608838)
,p_plugin_attribute_id=>wwv_flow_imp.id(25034614093608835)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25037858725608839)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25038352689608840)
,p_plugin_attribute_id=>wwv_flow_imp.id(25037858725608839)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25038910619608840)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25039482456608841)
,p_plugin_attribute_id=>wwv_flow_imp.id(25038910619608840)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25040002817608842)
,p_plugin_attribute_id=>wwv_flow_imp.id(25038910619608840)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25040655012608842)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25041197227608843)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25041625628608843)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1695354043769406990)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25042191927608844)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25042660063608845)
,p_plugin_attribute_id=>wwv_flow_imp.id(25042191927608844)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25043230308608845)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25043648995608846)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2163816379184568823)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2163817638704572971)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2150222750510162090)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2150902051240245194)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2163814444117523837)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2163815777507537694)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2224141086047612103)
,p_plugin_id=>wwv_flow_imp.id(353604438808672241)
,p_name=>'Badge Link'
