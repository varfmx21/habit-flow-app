...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(353641545936672267)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1824995610606492418)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1824995055594492417)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24978304038608771)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24978893018608772)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24979340810608772)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24979888898608773)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24980378183608773)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(24979340810608772)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1824995610606492418)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24980835225608774)
,p_plugin_attribute_id=>wwv_flow_imp.id(24980378183608773)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24981486571608774)
,p_plugin_attribute_id=>wwv_flow_imp.id(24980378183608773)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24982003205608775)
,p_plugin_attribute_id=>wwv_flow_imp.id(24980378183608773)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24982645090608775)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(24980378183608773)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24983104045608776)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24983693741608776)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24984196667608777)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24984650742608777)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24985158593608778)
,p_plugin_attribute_id=>wwv_flow_imp.id(24984650742608777)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24985798403608778)
,p_plugin_attribute_id=>wwv_flow_imp.id(24984650742608777)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24986387804608779)
,p_plugin_attribute_id=>wwv_flow_imp.id(24984650742608777)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24986991818608779)
,p_plugin_attribute_id=>wwv_flow_imp.id(24984650742608777)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24987597791608780)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(24979888898608773)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1824995055594492417)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24988052063608780)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24988523025608781)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24989050183608781)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24989591950608782)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24990054324608782)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24990589852608783)
,p_plugin_attribute_id=>wwv_flow_imp.id(24990054324608782)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24991100527608783)
,p_plugin_attribute_id=>wwv_flow_imp.id(24990054324608782)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24991713970608784)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24992242212608784)
,p_plugin_attribute_id=>wwv_flow_imp.id(24991713970608784)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24992827004608785)
,p_plugin_attribute_id=>wwv_flow_imp.id(24991713970608784)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24993468124608785)
,p_plugin_attribute_id=>wwv_flow_imp.id(24991713970608784)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24994027590608786)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24994591085608786)
,p_plugin_attribute_id=>wwv_flow_imp.id(24994027590608786)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24995186419608787)
,p_plugin_attribute_id=>wwv_flow_imp.id(24994027590608786)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24995726617608787)
,p_plugin_attribute_id=>wwv_flow_imp.id(24994027590608786)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24996345302608788)
,p_plugin_attribute_id=>wwv_flow_imp.id(24994027590608786)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24996967549608788)
,p_plugin_attribute_id=>wwv_flow_imp.id(24994027590608786)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24997552197608789)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24998034411608790)
,p_plugin_attribute_id=>wwv_flow_imp.id(24997552197608789)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24998620344608790)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2155623156550705820)
,p_plugin_id=>wwv_flow_imp.id(353641545936672267)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
