...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(353547882521672200)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24950977895608737)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24951453909608738)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24951945828608738)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24952418922608739)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24952946076608739)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24953462540608739)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24953904930608740)
,p_plugin_attribute_id=>wwv_flow_imp.id(24953462540608739)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24954511866608740)
,p_plugin_attribute_id=>wwv_flow_imp.id(24953462540608739)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24955197063608741)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24955638131608741)
,p_plugin_attribute_id=>wwv_flow_imp.id(24955197063608741)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24956211798608742)
,p_plugin_attribute_id=>wwv_flow_imp.id(24955197063608741)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24956852960608742)
,p_plugin_attribute_id=>wwv_flow_imp.id(24955197063608741)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(24957415769608743)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24957942476608743)
,p_plugin_attribute_id=>wwv_flow_imp.id(24957415769608743)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24958505420608744)
,p_plugin_attribute_id=>wwv_flow_imp.id(24957415769608743)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(24959123815608745)
,p_plugin_attribute_id=>wwv_flow_imp.id(24957415769608743)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2224092296043579358)
,p_plugin_id=>wwv_flow_imp.id(353547882521672200)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
